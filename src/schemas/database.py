...
from .enums import DatabaseOperation, DatabaseStatus
# 示例用常數
_EXAMPLE_TIMESTAMP_START = "2024-01-01T10:00:00Z"
_EXAMPLE_TIMESTAMP_END = "2024-01-01T10:00:01Z"
_EXAMPLE_TIMESTAMP_CONNECTED = "2024-01-01T09:00:00Z"
            ...
            "examples": [
                {
                    ...
                    "execution_time": 0.15,
                    "started_at": _EXAMPLE_TIMESTAMP_START,
                    "completed_at": _EXAMPLE_TIMESTAMP_END
                }
            ]
        }
    }
            ...
            "examples": [
                {
                    ...
                    "database": "bioneuronai",
                    "status": "connected",
                    "connected_at": _EXAMPLE_TIMESTAMP_CONNECTED,
                    "last_activity": _EXAMPLE_TIMESTAMP_START,
