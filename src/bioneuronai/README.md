...
| 模組 | README | 行數 | 職責 |
|------|--------|------|------|
| **planning/** | `planning/` | 已搬移 | 計劃控制 · SOP · 檢查 |
| **trading/** | [trading/README.md](trading/README.md) | 重整中 | 訂單 / 帳戶 / 持倉 / 資金狀態 |
...
from bioneuronai.planning import TradingPlanController
