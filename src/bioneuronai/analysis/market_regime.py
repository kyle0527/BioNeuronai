...
class MarketRegimeDetector:
    ...
    def detect_regime(self, symbol: str) -> Optional[RegimeAnalysis]:
        ...
        # 1.
        trend_direction, trend_strength, trend_score = self._analyze_trend(price_array)

        # 2.
        _, atr_percent = self._calculate_atr(high_array, low_array, price_array)
        ...
        # 3.  ADX
        adx, plus_di, minus_di = self._calculate_adx(high_array, low_array, price_array)
