...
├── README.md                    # 本說明文件
├── scripts/                     # 下載腳本
│   ├── download_kline.py       # K線數據下載
│   ├── download_trade.py       # 交易數據下載
│   ├── download_aggTrade.py    # 聚合交易數據下載
│   ├── enums.py                # 常量定義
│   ├── utility.py              # 工具函數
...
```bash
# Windows PowerShell
$env:STORE_DIRECTORY="C:\D\E\BioNeuronai\data_downloads\binance_historical"

# Linux/Mac
export STORE_DIRECTORY=/path/to/BioNeuronai/data_downloads/binance_historical
```
