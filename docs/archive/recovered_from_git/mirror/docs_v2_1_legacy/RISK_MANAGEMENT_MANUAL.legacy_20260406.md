...
> **版本**: v2.1  
> **更新日期**: 2026-01-22  
> **模組**: `src.bioneuronai.risk_management.position_manager`
...
```python
from src.bioneuronai.risk_management import RiskManager
...
# 或強制重新導入
import importlib
import src.bioneuronai.risk_management.position_manager as rm_module
