...
- [1. 系統概覽](#1-系統概覽)
  - [核心原則](#核心原則)
- [2. CLI 命令行回測](#2-cli-命令行回測)
  - [基礎使用](#基礎使用)
  - [紙交易模擬 (Simulate)](#紙交易模擬-simulate)
- [3. 自定義分析與腳本](#3-自定義分析與腳本)
  - [第一步：定義並驅動 BacktestEngine](#第一步定義並驅動-backtestengine)
  - [方法 2：runwithtrading_engine() — 完整策略管道回測](#方法-2runwithtradingengine-完整策略管道回測)
- [4. 核心資料流與組件](#4-核心資料流與組件)
...
```bash
python main.py backtest --symbol BTCUSDT --interval 1h --start-date 2020-01-01 --end-date 2020-01-03 --warmup-bars 10
```
