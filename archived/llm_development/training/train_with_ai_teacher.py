...
def train_with_ai_teacher(
    ...
    output_dir: str = "models/tiny_llm_en_zh_trained",
    epochs: int = 10,
    batch_size: int = 4,
    ...
    print(f"  • 真實訓練需要更多數據和更長時間")
    print(f"  • 可以繼續訓練或添加更多數據")
    print(f"  • 使用 'python view_training_history.py' 查看完整歷史")
...
if __name__ == "__main__":
    ...
    train_with_ai_teacher(
        ...
        output_dir="models/tiny_llm_en_zh_trained",
        epochs=20,  # 訓練 20 輪
        batch_size=4,
        learning_rate=5e-5,
        max_length=128,
